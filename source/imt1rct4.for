C
      SUBROUTINE IMT1RCT4AL(INRCT,IOUT,ISUM,ISUM2,NCOL,NROW,NLAY,NCOMP,
...
C
C
      SUBROUTINE IMT1RCT4RP(IN,IOUT,NCOL,NROW,NLAY,NCOMP,ICBUND,COLD,
...
C
C
      SUBROUTINE IMT1RCT4SV(NCOL,NROW,NLAY,NCOMP,ICOMP,ICBUND,PRSITY,
...
C
C
      SUBROUTINE IMT1RCT4FM(NCOL,NROW,NLAY,NCOMP,ICOMP,ICBUND,PRSITY,
...
C
C
      SUBROUTINE IMT1RCT4BD(NCOL,NROW,NLAY,NCOMP,ICOMP,ICBUND,PRSITY,
...
C
C
      SUBROUTINE IMT1RCT4CF(NCOL,NROW,NLAY,NCOMP,ICOMP,ICBUND,PRSITY,
