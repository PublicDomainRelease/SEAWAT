     ...
     1              NCOL,NROW,NLAY,NGHBVL,PS,ELEV,HNEW,MTDNCONC,
...
C--SEAWAT: DIMENSION ADDITIONAL ARRAYS
     ...
     &          HNEW(NCOL,NROW,NLAY),SS(NSSVL,MXSS),SSMC(NCOMP,MXSS)
	INCLUDE 'vdf.inc'
...
C--SEAWAT: SET GHBDENS 
		...
		IF(MTDNCONC.GT.0) GHBDENS=SSMDENSE(IC,IR,IL,5,MXSS,NSS,SS,
     &                                       NCOMP,SSMC,MTDNCONC)
...
C7------RETURN.
     ...
     2   PERTIM,TOTIM,NGHBVL,IGHBAL,IAUXSV,PS,ELEV,MTDNCONC,MXSS,NSS,
     3   SS,NCOMP,SSMC,NSSVL)
...
C--SEAWAT: DIMENSION ADDITIONAL ARRAYS
      DIMENSION PS(NCOL,NROW,NLAY),ELEV(NCOL,NROW,NLAY),SS(NSSVL,MXSS),
     &          SSMC(NCOMP,MXSS)
	INCLUDE 'vdf.inc'
C     ------------------------------------------------------------------
C
