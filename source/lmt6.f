...
C--SEAWAT: LANGEVIN UPDATED WITH MODFLOW VERSION 1.12.01 (10/22/2003)
C
C ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
C
     ...
     &  NCOL,NROW,NLAY,IBOUND,KSTP,KPER,IOUT,INUHF)
C ********************************************************************
...
C
     ...
     &  NCOL,NROW,NLAY,KSTP,KPER,BUFF,IOUT,INUHF)
C ******************************************************************
...
C
     ...
     & KPER,IFHBD4,NFLWDIM,IOUT,INUHF)
C **********************************************************************
...
C
     ...
     &  BUFF,KSTP,KPER,NRES,NRESOP,NCOL,NROW,NLAY,IOUT,INUHF)
C **********************************************************************
...
C
     ...
     &  NLAY,KSTP,KPER,IOUT,ILMTHEAD,INUHF)
C **********************************************************************
...
C--SEAWAT: WRITE SINGLE OR DOUBLE PRECISION DEPENDING ON INUHF
		...
		ELSE
			WRITE(IOUT) IL,IR,IC,REAL(Q,4),iGroup,REAL(QSW,4)
		ENDIF
        ELSEIF(ILMTFMT.EQ.1) THEN
          WRITE(IOUT,*) IL,IR,IC,Q,iGroup,QSW
        ENDIF
